...
export default class Events {
  ...
  on(name, callback, context) {
    this._events = this.eventsApi(this.onApi, this._events || {}, name, callback, {
      context: context,
      ctx: this,
  ...
  listenTo(obj, name, callback) {
    ...
    var error = this.tryCatchOn(obj, name, callback, this);
    _listening = void 0;
  ...
  // `_listening` variable.
  tryCatchOn(obj, name, callback, context) {
    try {
...
class Listening extends Events {
